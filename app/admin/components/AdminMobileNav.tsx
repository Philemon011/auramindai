...
const tabs = [
  ...
  { label: "Sessions", href: "/admin/masterclasses", icon: GraduationCap, exact: false },
  { label: "Membres", href: "/admin/utilisateurs", icon: Users, exact: false },
    ...
    <>
      ...
      <header className="sticky top-0 z-40 flex h-16 items-center justify-between border-b border-border bg-surface/90 px-5 backdrop-blur-md lg:hidden">
        <div className="flex items-center gap-2">
          ...
          <span className="rounded-full bg-accent-soft px-2 py-0.5 font-body text-[9px] font-semibold uppercase tracking-wide text-accent">
            Admin
          </span>
        </div>
        <button
      ...
      {/* Barre de navigation basse, façon app native */}
      ...
      {/* Feuille du compte (bottom sheet) */}
      <AnimatePresence>
        {sheetOpen && (
          <>
            <motion.div
