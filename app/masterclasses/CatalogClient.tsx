...
type MasterclassLanguage = "fr" | "en";
...
const languageFilters: { label: string; value: "all" | MasterclassLanguage }[] = [
  { label: "Toutes langues", value: "all" },
...
export function CatalogClient({ masterclasses }: { masterclasses: PublicMasterclass[] }) {
  ...
  }, [masterclasses, search, typeFilter, languageFilter]);
      ...
      {paginated.length > 0 ? (
        ...
        <div className="mt-20 flex flex-col items-center text-center">
          <p className="font-subheading text-xl font-semibold text-foreground">
            {masterclasses.length === 0 ? "Aucune masterclass pour l'instant" : "Aucune masterclass ne correspond"}
          </p>
          <p className="mt-2 font-body text-sm text-foreground-muted">
            {masterclasses.length === 0
              ? "Reviens bientôt, le programme se remplit régulièrement."
